                                    ...
                                    <Slider {...settings}>
                                        <div>
                                            <div className="bd-banner__image-2">
                                                <Image width={1280} height={576} priority={true} src={`/assets/img/new/1-new.jpeg`} placeholder="blur" blurDataURL={`/assets/img/new/1-new.jpeg`} alt="banner-img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div className="bd-banner__image-2">
                                            <Image width={1280} height={576} priority={false} src={`/assets/img/new/2-new.jpeg`} placeholder="blur" blurDataURL={`/assets/img/new/2-new.jpeg`} alt="banner-img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div className="bd-banner__image-2">
                                            <Image width={1280} height={576} priority={false} src={`/assets/img/new/3-new.jpeg`} placeholder="blur" blurDataURL={`/assets/img/new/3-new.jpeg`}  alt="banner-img" />
                                            </div>
                                        </div>
                                    </Slider>
                                </div>
